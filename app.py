...
st.text("Note: There are only 3 candiates calendars available [Alice, Bob, Jane] you are one of them and can schedule a meeting with either of the two or both:")
